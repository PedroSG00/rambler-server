...
const { tripList, myTrips, tripDetails, createTrips, joinTrip, leaveTrip, editTrip, deleteTrip, searchTrip, requestWaypoint, acceptRequest, updateTripState } = require('../controllers/trip.controller')
